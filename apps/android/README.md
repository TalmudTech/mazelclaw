## MazelClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_mazelclaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm mazelclaw gateway --port 18789 --verbose
```
