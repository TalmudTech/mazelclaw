...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.mazelclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.mazelclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: MazelClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
