...
public enum MazelClawTalkCommand: String, Codable, Sendable {
...
public struct MazelClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MazelClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
