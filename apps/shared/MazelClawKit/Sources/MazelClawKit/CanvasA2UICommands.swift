...
public enum MazelClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct MazelClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MazelClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
