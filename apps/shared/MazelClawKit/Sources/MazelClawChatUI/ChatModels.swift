...
public typealias MazelClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MazelClawPlatformImage = UIImage
#endif

public struct MazelClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct MazelClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MazelClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MazelClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MazelClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct MazelClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MazelClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MazelClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MazelClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MazelClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MazelClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MazelClawChatMessageContent].self, forKey: .content) {
...
public struct MazelClawChatHistoryPayload: Codable, Sendable {
...
public struct MazelClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MazelClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MazelClawSessionPreviewItem]
}

public struct MazelClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MazelClawSessionPreviewEntry]

    public init(ts: Int, previews: [MazelClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MazelClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MazelClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MazelClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MazelClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MazelClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MazelClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MazelClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: MazelClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct MazelClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
