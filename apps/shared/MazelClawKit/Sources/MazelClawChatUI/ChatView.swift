...
@MainActor
public struct MazelClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MazelClawChatViewModel
    ...
    public init(
        viewModel: MazelClawChatViewModel,
    ...
    private var visibleMessages: [MazelClawChatMessage] {
        let base: [MazelClawChatMessage]
    ...
    private func mergeToolResults(in messages: [MazelClawChatMessage]) -> [MazelClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = MazelClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: MazelClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MazelClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MazelClawChatMessage) -> String {
