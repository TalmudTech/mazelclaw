...
@Suite struct VoiceWakeRuntimeTests {
    ...
    @Test func hasContentAfterTriggerFalseWhenOnlyTrigger() {
        let triggers = ["mazelclaw"]
        let text = "hey mazelclaw"
    ...
    @Test func gateRequiresGapBetweenTriggerAndCommand() {
        let transcript = "hey mazelclaw do thing"
        ...
        let config = WakeWordGateConfig(triggers: ["mazelclaw"], minPostTriggerGap: 0.3)
