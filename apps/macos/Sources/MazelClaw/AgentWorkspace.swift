...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.mazelclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MazelClawConfigFile.defaultWorkspaceURL() }
