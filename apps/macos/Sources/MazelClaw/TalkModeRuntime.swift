...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.mazelclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.mazelclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MazelClawChatMessage] = messages.compactMap { item in
