...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.mazelclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("MazelClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__mazelclaw__/a2ui/").absoluteString + "?platform=macos"
    }
