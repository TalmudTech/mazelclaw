...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.mazelclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mazelclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mazelclawCommand(
            subcommand: "gateway",
