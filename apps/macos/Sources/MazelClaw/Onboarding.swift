...
enum UIStrings {
    static let welcomeTitle = "Welcome to MazelClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "mazelclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MazelClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MazelClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mazelclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MazelClawChatViewModel(
