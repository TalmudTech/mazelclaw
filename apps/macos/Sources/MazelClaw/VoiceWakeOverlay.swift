...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.mazelclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other MazelClaw windows, but below the system’s pop-up menus.
