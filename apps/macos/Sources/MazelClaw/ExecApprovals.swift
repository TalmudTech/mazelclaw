...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.mazelclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        MazelClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        MazelClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
