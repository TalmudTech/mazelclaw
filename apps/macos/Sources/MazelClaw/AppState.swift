...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MazelClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MazelClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = MazelClawConfigFile.loadDict()
            ...
            MazelClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mazelclaw"
        state.remoteCliPath = ""
        return state
    }
}
