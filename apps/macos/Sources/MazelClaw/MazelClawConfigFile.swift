...
enum MazelClawConfigFile {
    private static let logger = Logger(subsystem: "ai.mazelclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        MazelClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MazelClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-mazelclaw-config-file",
            "event": "config.write",
