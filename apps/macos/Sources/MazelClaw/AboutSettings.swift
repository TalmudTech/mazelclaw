...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/mazelclaw/mazelclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/mazelclaw/mazelclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mazelclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MazelClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MazelClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MazelClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MazelClawGitCommit") as? String) ??
            "unknown"
    }
