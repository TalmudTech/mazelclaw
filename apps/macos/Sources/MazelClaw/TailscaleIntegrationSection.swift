...
struct TailscaleIntegrationSection: View {
    ...
    private var authFields: some View {
        ...
        Text("Stored in ~/.mazelclaw/mazelclaw.json. Prefer MAZELCLAW_GATEWAY_PASSWORD for production.")
            .font(.caption)
            .foregroundStyle(.secondary)
    ...
    private func applySettings() async {
        ...
        if self.connectionMode == .local, !self.isPaused {
            self.statusMessage = "Saved to ~/.mazelclaw/mazelclaw.json. Restarting gateway…"
        } else {
            self.statusMessage = "Saved to ~/.mazelclaw/mazelclaw.json. Restart the gateway to apply."
        }
