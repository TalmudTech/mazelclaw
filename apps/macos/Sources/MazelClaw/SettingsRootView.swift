...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mazelclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MazelClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MazelClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let mazelclawSelectSettingsTab = Notification.Name("mazelclawSelectSettingsTab")
}
