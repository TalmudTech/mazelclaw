...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MazelClawPhotosLatestParams) async throws -> MazelClawPhotosLatestPayload {
        ...
        var results: [MazelClawPhotoPayload] = []
        ...
        return MazelClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MazelClawPhotoPayload
    {
