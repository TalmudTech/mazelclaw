...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.mazelclaw.gateway"
    private static let nodeService = "ai.mazelclaw.node"
    private static let talkService = "ai.mazelclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.mazelclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.mazelclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("mazelclaw-gateway.log")
    }
