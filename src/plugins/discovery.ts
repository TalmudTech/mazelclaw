...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @mazelclaw/voice-call -> voice-call).
...
export function discoverMazelClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".mazelclaw", "extensions")];
