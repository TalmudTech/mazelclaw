...
export const normalizePluginsConfig = (
  config?: MazelClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: MazelClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: MazelClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: MazelClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
