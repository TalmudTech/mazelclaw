...
export type MazelClawPluginConfigSchema = {
...
export type MazelClawPluginToolContext = {
...
export type MazelClawPluginToolFactory = (
  ctx: MazelClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MazelClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type MazelClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MazelClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MazelClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current MazelClaw configuration */
  config: MazelClawConfig;
 ...
 */
export type MazelClawPluginCommandDefinition = {
...
export type MazelClawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type MazelClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type MazelClawPluginCliContext = {
  program: Command;
  config: MazelClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MazelClawPluginCliRegistrar = (ctx: MazelClawPluginCliContext) => void | Promise<void>;

export type MazelClawPluginServiceContext = {
  config: MazelClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MazelClawPluginService = {
  id: string;
  start: (ctx: MazelClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MazelClawPluginServiceContext) => void | Promise<void>;
};

export type MazelClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MazelClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: MazelClawPluginConfigSchema;
  register?: (api: MazelClawPluginApi) => void | Promise<void>;
  activate?: (api: MazelClawPluginApi) => void | Promise<void>;
};

export type MazelClawPluginModule =
  | MazelClawPluginDefinition
  | ((api: MazelClawPluginApi) => void | Promise<void>);

export type MazelClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | MazelClawPluginToolFactory,
    opts?: MazelClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: MazelClawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: MazelClawPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: MazelClawPluginHttpRouteHandler }) => void;
  registerChannel: (registration: MazelClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: MazelClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MazelClawPluginService) => void;
   ...
   */
  registerCommand: (command: MazelClawPluginCommandDefinition) => void;
