...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MazelClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MazelClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: MazelClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
