...
function mergeIMessageAccountConfig(cfg: MazelClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MazelClawConfig): ResolvedIMessageAccount[] {
