...
function mergeDiscordAccountConfig(cfg: MazelClawConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MazelClawConfig): ResolvedDiscordAccount[] {
