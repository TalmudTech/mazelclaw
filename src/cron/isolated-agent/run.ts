...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/mazelclaw/mazelclaw/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MAZELCLAW_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.mazelclaw/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MazelClawConfig = {
    ...params.cfg,
