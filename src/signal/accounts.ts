...
function mergeSignalAccountConfig(cfg: MazelClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MazelClawConfig): ResolvedSignalAccount[] {
