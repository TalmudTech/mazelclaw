...
function resolveMentionPatterns(cfg: MazelClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MazelClawConfig | undefined, agentId?: string): RegExp[] {
