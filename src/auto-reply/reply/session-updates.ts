...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: MazelClawConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: MazelClawConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.MAZELCLAW_TEST_FAST === "1") {
