...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mazelclaw", { botUsername: "mazelclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mazelclaw args", {
        botUsername: "mazelclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@mazelclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mazelclaw" })).toBe(
      "/help@otherbot",
    );
  });
