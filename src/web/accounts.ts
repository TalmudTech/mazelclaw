...
export function listWhatsAppAuthDirs(cfg: MazelClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MazelClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MazelClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MazelClawConfig): ResolvedWhatsAppAccount[] {
