...
function mergeSlackAccountConfig(cfg: MazelClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MazelClawConfig): ResolvedSlackAccount[] {
