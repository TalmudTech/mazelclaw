...
// Prefix for MazelClaw-generated action IDs to scope our handler
const MAZELCLAW_ACTION_PREFIX = "mazelclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle MazelClaw modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${MAZELCLAW_ACTION_PREFIX}`),
