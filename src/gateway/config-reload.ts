...
import type { MazelClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MazelClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MazelClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MazelClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MazelClawConfig) => void;
  log: {
