...
import { createMazelClawTools } from "../agents/mazelclaw-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-mazelclaw-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-mazelclaw-account-id")?.trim() || undefined;
  ...
  const allTools = createMazelClawTools({
