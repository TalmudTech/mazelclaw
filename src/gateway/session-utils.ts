...
import { type MazelClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MazelClawConfig): string[] {
...
export function listAgentsForGateway(cfg: MazelClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MazelClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: MazelClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MazelClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MazelClawConfig): GatewaySessionsDefaults {
