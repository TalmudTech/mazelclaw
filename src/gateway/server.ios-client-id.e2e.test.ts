...
beforeAll(async () => {
  previousToken = process.env.MAZELCLAW_GATEWAY_TOKEN;
  process.env.MAZELCLAW_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.MAZELCLAW_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "mazelclaw-ios", platform: "ios" },
  { clientId: "mazelclaw-android", platform: "android" },
