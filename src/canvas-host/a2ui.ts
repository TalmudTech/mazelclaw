...
export const A2UI_PATH = "/__mazelclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__mazelclaw__/canvas";

export const CANVAS_WS_PATH = "/__mazelclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.mazelclawCanvasA2UIAction.postMessage(...)
  // - Android: window.mazelclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["mazelclawCanvasA2UIAction"];
  ...
  globalThis.MazelClaw = globalThis.MazelClaw ?? {};
  globalThis.MazelClaw.postMessage = postToNode;
  globalThis.MazelClaw.sendUserAction = sendUserAction;
  globalThis.mazelclawPostMessage = postToNode;
  globalThis.mazelclawSendUserAction = sendUserAction;
