...
import type { MazelClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: MazelClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: MazelClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
