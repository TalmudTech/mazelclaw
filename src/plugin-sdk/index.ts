...
export type { MazelClawConfig } from "../config/config.js";
/** @deprecated Use MazelClawConfig instead */
export type { MazelClawConfig as ClawdbotConfig } from "../config/config.js";
