...
function setSlackDmPolicy(cfg: MazelClawConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "MazelClaw";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for MazelClaw`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: MazelClawConfig, allowFrom: string[]): MazelClawConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
