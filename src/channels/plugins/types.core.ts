...
export type ChannelAgentToolFactory = (params: { cfg?: MazelClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MazelClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MazelClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MazelClawConfig }) => boolean;
  supportsCards?: (params: { cfg: MazelClawConfig }) => boolean;
