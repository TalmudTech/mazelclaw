...
function resolveDefaultAccountId(cfg: MazelClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MazelClawConfig): boolean {
...
export function summarizeBindings(cfg: MazelClawConfig, bindings: AgentBinding[]): string[] {
