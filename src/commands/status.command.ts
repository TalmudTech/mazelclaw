...
export async function statusCommand(
  ...
  runtime.log(theme.heading("MazelClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("mazelclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("mazelclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.mazelclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.mazelclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("mazelclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("mazelclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("mazelclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("mazelclaw gateway probe")}`);
  }
}
