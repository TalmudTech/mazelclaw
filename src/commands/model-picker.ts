...
type PromptDefaultModelResult = { model?: string; config?: MazelClawConfig };
...
function resolveConfiguredModelRaw(cfg: MazelClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: MazelClawConfig): string[] {
...
export function applyPrimaryModel(cfg: MazelClawConfig, model: string): MazelClawConfig {
...
export function applyModelAllowlist(cfg: MazelClawConfig, models: string[]): MazelClawConfig {
  const defaults = cfg.agents?.defaults;
