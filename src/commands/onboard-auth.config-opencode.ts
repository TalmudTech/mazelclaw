...
export function applyOpencodeZenProviderConfig(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyOpencodeZenConfig(cfg: MazelClawConfig): MazelClawConfig {
