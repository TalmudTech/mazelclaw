...
export function applyVercelAiGatewayProviderConfig(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: MazelClawConfig): MazelClawConfig {
