...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MAZELCLAW_TTS_PREFS;
      process.env.MAZELCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MAZELCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MazelClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
