...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "mazelclaw-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "mazelclaw.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "mazelclaw.sandbox=1",
        "--label",
        "mazelclaw.sessionKey=main",
        "--label",
        "mazelclaw.createdAtMs=1700000000000",
        "--label",
