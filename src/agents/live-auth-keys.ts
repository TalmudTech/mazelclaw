...
const GOOGLE_LIVE_SINGLE_KEY = "MAZELCLAW_LIVE_GEMINI_KEY";
...
const PROVIDER_API_KEY_CONFIG: Record<string, Omit<ProviderApiKeyConfig, "fallbackVars">> = {
  anthropic: {
    liveSingle: "MAZELCLAW_LIVE_ANTHROPIC_KEY",
    listVar: "MAZELCLAW_LIVE_ANTHROPIC_KEYS",
  ...
  openai: {
    liveSingle: "MAZELCLAW_LIVE_OPENAI_KEY",
...
function resolveProviderApiKeyConfig(provider: string): ProviderApiKeyConfig {
  ...
  const liveSingle = custom?.liveSingle ?? `MAZELCLAW_LIVE_${base}_KEY`;
