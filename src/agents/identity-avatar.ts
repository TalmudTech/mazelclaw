...
function resolveAvatarSource(cfg: MazelClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MazelClawConfig, agentId: string): AgentAvatarResolution {
