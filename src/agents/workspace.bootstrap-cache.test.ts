...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("mazelclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("mazelclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("mazelclaw-cache-test2-");
