...
export const DEFAULT_SANDBOX_IMAGE = "mazelclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mazelclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mazelclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mazelclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mazelclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mazelclaw-sandbox-browser";
