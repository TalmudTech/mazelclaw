...
function resolveAdaptiveReadMaxBytes(options?: MazelClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMazelClawReadTool(base, {
...
export function createMazelClawReadTool(
  base: AnyAgentTool,
  options?: MazelClawReadToolOptions,
): AnyAgentTool {
