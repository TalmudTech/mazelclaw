...
function makeCfg(overrides: Partial<MazelClawConfig> = {}): MazelClawConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): MazelClawConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): MazelClawConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
