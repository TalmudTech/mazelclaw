...
function resolveMemoryToolContext(options: { config?: MazelClawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: MazelClawConfig): MemoryCitationsMode {
