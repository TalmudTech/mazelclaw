...
const CLEANUP_STATE_KEY = Symbol.for("mazelclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mazelclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mazelclaw.sessionWriteLockWatchdogState");
