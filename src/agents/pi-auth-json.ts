...
/**
 * Convert an MazelClaw auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * MazelClaw stores credentials in auth-profiles.json instead. This helper
