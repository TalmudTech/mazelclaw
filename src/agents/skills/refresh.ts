...
function resolveWatchPaths(workspaceDir: string, config?: MazelClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MazelClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MazelClawConfig }) {
