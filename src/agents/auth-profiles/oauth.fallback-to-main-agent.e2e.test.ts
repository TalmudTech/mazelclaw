...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveMazelClawAgentDir() returns mainAgentDir
    process.env.MAZELCLAW_STATE_DIR = tmpDir;
    process.env.MAZELCLAW_AGENT_DIR = mainAgentDir;
