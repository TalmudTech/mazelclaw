...
function resolveAnthropicDefaultAuthMode(cfg: MazelClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyTalkApiKey(config: MazelClawConfig): MazelClawConfig {
...
export function applyModelDefaults(cfg: MazelClawConfig): MazelClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyLoggingDefaults(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyContextPruningDefaults(cfg: MazelClawConfig): MazelClawConfig {
...
export function applyCompactionDefaults(cfg: MazelClawConfig): MazelClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
