...
function isTelegramConfigured(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MazelClawConfig): boolean {
...
function isIMessageConfigured(cfg: MazelClawConfig): boolean {
...
function isWhatsAppConfigured(cfg: MazelClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: MazelClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MazelClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MazelClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: MazelClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MazelClawConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: MazelClawConfig, pluginId: string): MazelClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
