...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("mazelclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "mazelclaw");
