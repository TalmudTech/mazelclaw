...
function resolveGatewayPort(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: MazelClawConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.MAZELCLAW_GATEWAY_PASSWORD?.trim() ||
