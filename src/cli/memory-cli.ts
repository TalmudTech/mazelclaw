    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mazelclaw memory status", "Show index and provider status."],
          ["mazelclaw memory index --force", "Force a full reindex."],
          ['mazelclaw memory search --query "deployment notes"', "Search indexed memory entries."],
          ["mazelclaw memory status --json", "Output machine-readable JSON."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.mazelclaw.ai/cli/memory")}\n`,
    );
