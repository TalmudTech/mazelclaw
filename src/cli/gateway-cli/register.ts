      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mazelclaw gateway run", "Run the gateway in the foreground."],
            ["mazelclaw gateway status", "Show service status and probe reachability."],
            ["mazelclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["mazelclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.mazelclaw.ai/cli/gateway")}\n`,
      ),
  );
