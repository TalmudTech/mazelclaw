...
const SANDBOX_EXAMPLES = {
  main: [
    ["mazelclaw sandbox list", "List all sandbox containers."],
    ["mazelclaw sandbox list --browser", "List only browser containers."],
    ["mazelclaw sandbox recreate --all", "Recreate all containers."],
    ["mazelclaw sandbox recreate --session main", "Recreate a specific session."],
    ["mazelclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mazelclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mazelclaw sandbox list", "List all sandbox containers."],
    ["mazelclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["mazelclaw sandbox recreate --all", "Recreate all containers."],
    ["mazelclaw sandbox recreate --session main", "Recreate a specific session."],
    ["mazelclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mazelclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mazelclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mazelclaw sandbox explain", "Show effective sandbox config."],
    ["mazelclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mazelclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["mazelclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.mazelclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
