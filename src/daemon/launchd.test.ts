...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.mazelclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MAZELCLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.mazelclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.mazelclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MAZELCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.mazelclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when MAZELCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MAZELCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.mazelclaw.jbphoenix.plist",
    },
    {
      name: "prefers MAZELCLAW_LAUNCHD_LABEL over MAZELCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        MAZELCLAW_PROFILE: "jbphoenix",
        MAZELCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MAZELCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MAZELCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MAZELCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MAZELCLAW_PROFILE: "myprofile",
        MAZELCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.mazelclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
