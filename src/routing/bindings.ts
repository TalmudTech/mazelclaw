...
export function listBindings(cfg: MazelClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: MazelClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: MazelClawConfig) {
