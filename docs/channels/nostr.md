...
read_when:
  - You want MazelClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables MazelClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`mazelclaw onboard`) and `mazelclaw channels add` list optional channel plugins.
...
```bash
mazelclaw plugins install @mazelclaw/nostr
```

Use a local checkout (dev workflows):

```bash
mazelclaw plugins install --link <path-to-mazelclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "mazelclaw",
        "displayName": "MazelClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "mazelclaw@example.com",
        "lud16": "mazelclaw@example.com"
      }
    }
  }
}
