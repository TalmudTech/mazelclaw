...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure MazelClaw HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `mazelclaw pairing approve slack <code>`.
...
MazelClaw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, MazelClaw falls back to normal delivery for remaining payloads.
