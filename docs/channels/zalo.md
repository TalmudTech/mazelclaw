...
- Install via CLI: `mazelclaw plugins install @mazelclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `mazelclaw plugins install ./extensions/zalo`
   - From npm (if published): `mazelclaw plugins install @mazelclaw/zalo`
...
- Approve via:
  - `mazelclaw pairing list zalo`
  - `mazelclaw pairing approve zalo <CODE>`
...
- Example: `mazelclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `mazelclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `mazelclaw logs --follow`
