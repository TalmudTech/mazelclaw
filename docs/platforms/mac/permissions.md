...
- Same path: run the app from a fixed location (for MazelClaw, `dist/MazelClaw.app`).
...
Workaround: move files into the MazelClaw workspace (`~/.mazelclaw/workspace`) if you want to avoid per-folder grants.
