...
mazelclaw system heartbeat last
mazelclaw logs --follow
mazelclaw config get agents.defaults.heartbeat
mazelclaw channels status --probe
```
...
```bash
mazelclaw config get agents.defaults.heartbeat.activeHours
mazelclaw config get agents.defaults.heartbeat.activeHours.timezone
mazelclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
mazelclaw cron list
mazelclaw logs --follow
```
