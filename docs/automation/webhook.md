...
read_when:
  ...
  - Wiring external systems into MazelClaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your MazelClaw config directory (typically `~/.mazelclaw/hooks/transforms`).
...
- `mazelclaw webhooks gmail setup` writes `hooks.gmail` config for `mazelclaw webhooks gmail run`.
