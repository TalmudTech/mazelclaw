...
- 生成的 Swift 模型：`apps/macos/Sources/MazelClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/mazelclaw/mazelclaw/main/dist/protocol.schema.json
