...
summary: "`mazelclaw skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
mazelclaw skills list
mazelclaw skills list --eligible
mazelclaw skills info <name>
mazelclaw skills check
```
