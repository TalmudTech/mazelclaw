...
本指南总结了在 MazelClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 MazelClaw 状态目录下。默认为 `~/.mazelclaw`。如果设置了 `MAZELCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.mazelclaw.ai/testing
- https://docs.mazelclaw.ai/start/getting-started
