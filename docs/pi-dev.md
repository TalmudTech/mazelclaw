...
This guide summarizes a sane workflow for working on the pi integration in MazelClaw.
...
- Trigger the agent directly:
  - `pnpm mazelclaw agent --message "Hello" --thinking low`
...
State lives under the MazelClaw state directory. Default is `~/.mazelclaw`. If `MAZELCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `mazelclaw.json` for config
...
- [https://docs.mazelclaw.ai/testing](https://docs.mazelclaw.ai/testing)
- [https://docs.mazelclaw.ai/start/getting-started](https://docs.mazelclaw.ai/start/getting-started)
