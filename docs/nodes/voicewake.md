...
MazelClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.mazelclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["mazelclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
