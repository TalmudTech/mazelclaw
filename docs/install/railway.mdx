...
Deploy MazelClaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/mazelclaw` — Control UI
...
- `MAZELCLAW_STATE_DIR=/data/.mazelclaw` (recommended)
- `MAZELCLAW_WORKSPACE_DIR=/data/workspace` (recommended)
- `MAZELCLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your MazelClaw state + workspace so you can migrate to another host without losing config or memory.
