...
- **gateway host** → `mazelclaw` process on the gateway machine
...
`~/.mazelclaw/exec-approvals.json` directly.

CLI: `mazelclaw approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
