---
summary: "First-run onboarding flow for MazelClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give MazelClaw">
...
<Step title="CLI">
  ...
  The app can install the global `mazelclaw` CLI via npm/pnpm so terminal
