---
summary: "Overview of MazelClaw onboarding options and flows"
read_when:
...
MazelClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`mazelclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the MazelClaw app when you want a fully guided setup on macOS. Docs:
