---
summary: "Use Synthetic's Anthropic-compatible API in MazelClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. MazelClaw registers it as the
...
Note: MazelClaw's Anthropic client appends `/v1` to the base URL, so use
