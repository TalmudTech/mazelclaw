---
summary: "Use Qianfan's unified API to access many models in MazelClaw"
read_when:
...
3. MazelClaw installed on your system
...
4. Copy the API key for use with MazelClaw

## CLI setup

```bash
mazelclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [MazelClaw Configuration](/gateway/configuration)
