---
summary: "Use NVIDIA's OpenAI-compatible API in MazelClaw"
read_when:
  - You want to use NVIDIA models in MazelClaw
...
mazelclaw onboard --auth-choice skip
mazelclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
