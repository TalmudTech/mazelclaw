---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with MazelClaw"
read_when:
  - You want Xiaomi MiMo models in MazelClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). MazelClaw uses
