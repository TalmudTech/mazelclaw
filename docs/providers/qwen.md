---
summary: "Use Qwen OAuth (free tier) in MazelClaw"
read_when:
  - You want to use Qwen with MazelClaw
...
If you already logged in with the Qwen Code CLI, MazelClaw will sync credentials
