...
read_when:
  - You are building a MazelClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (mazelclaw.plugin.json)

Every plugin **must** ship a `mazelclaw.plugin.json` file in the **plugin root**.
MazelClaw uses this manifest to validate configuration **without executing plugin
