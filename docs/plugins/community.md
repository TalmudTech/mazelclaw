...
read_when:
  - You want to publish a third-party MazelClaw plugin
...
This page tracks high-quality **community-maintained plugins** for MazelClaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `mazelclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `mazelclaw plugins install @scope/package`
