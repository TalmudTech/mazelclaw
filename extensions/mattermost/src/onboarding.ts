import type { ChannelOnboardingAdapter, MazelClawConfig, WizardPrompter } from "mazelclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.mazelclaw.ai/channels/mattermost",
    ].join("\n"),
