...
export function listMattermostAccountIds(cfg: MazelClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: MazelClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: MazelClawConfig): ResolvedMattermostAccount[] {
