...
export function listGoogleChatAccountIds(cfg: MazelClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: MazelClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: MazelClawConfig): ResolvedGoogleChatAccount[] {
