import type { LineChannelData, MazelClawPluginApi, ReplyPayload } from "mazelclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: MazelClawPluginApi): void {
  api.registerCommand({
    name: "card",
