...
Nostr DM channel plugin for MazelClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to MazelClaw. It enables your bot to:
...
# Configure mazelclaw to use local relay
