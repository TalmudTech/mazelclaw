...
This directory contains the **BlueBubbles external channel plugin** for MazelClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `mazelclaw/plugin-sdk` helpers.
