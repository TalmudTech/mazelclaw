...
import { resolveChannelMediaMaxBytes, type MazelClawConfig } from "mazelclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MazelClawConfig; accountId?: string }): string[] {
