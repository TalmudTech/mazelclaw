...
export function listZalouserAccountIds(cfg: MazelClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MazelClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: MazelClawConfig, accountId: string): ZalouserAccountConfig {
