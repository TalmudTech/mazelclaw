# Contributing to MazelClaw

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/mazelclaw/mazelclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@mazelclaw](https://x.com/mazelclaw)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/mazelclaw/mazelclaw/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your MazelClaw instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for MazelClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/mazelclaw/mazelclaw/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape MazelClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@mazelclaw.ai with:

- Links to your PRs on MazelClaw (if you don't have any, start there first)
