...
# Output:
# - dist/MazelClaw.app
# - dist/MazelClaw-<version>.zip
# - dist/MazelClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.mazelclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/MazelClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/MazelClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/MazelClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MazelClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/MazelClaw-$VERSION.dSYM.zip"
