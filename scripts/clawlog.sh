...
show_usage() {
    cat << EOF
clawlog - MazelClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MazelClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MazelClaw logs flow through the macOS unified log (subsystem: ai.mazelclaw).
