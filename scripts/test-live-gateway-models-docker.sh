...
docker run --rm -t \
  ...
  -e MAZELCLAW_LIVE_GATEWAY_MODELS="${MAZELCLAW_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e MAZELCLAW_LIVE_GATEWAY_PROVIDERS="${MAZELCLAW_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e MAZELCLAW_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${MAZELCLAW_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
