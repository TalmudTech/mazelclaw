...
- Keep product names in English: MazelClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the MazelClaw Gateway, use “Gateway 网关”.
