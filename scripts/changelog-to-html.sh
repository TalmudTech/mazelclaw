...
if [[ -z "$version_content" ]]; then
  echo "<h2>MazelClaw $VERSION</h2>"
  echo "<p>Latest MazelClaw update.</p>"
  echo "<p><a href=\"https://github.com/mazelclaw/mazelclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
